...
public interface ConversationMapper {
    ...
    @Select("SELECT * FROM conversation WHERE user_id = #{userId} AND role_id = #{roleId} ORDER BY created_at DESC")
    List<Conversation> findByUserIdAndRoleId(@Param("userId") Integer userId, @Param("roleId") Integer roleId);
